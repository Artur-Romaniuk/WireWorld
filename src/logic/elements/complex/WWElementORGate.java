...
public class WWElementORGate extends WWComplexElement {
    ...
    public LinkedList<WWElementConductor> getConductors() {
        ...
        if (this.direction == Direction.RIGHT || this.direction == Direction.LEFT) {
            ...
            result.add(new WWElementConductor(this.row + 4, this.column));
            ...
            result.add(new WWElementConductor(this.row + 2, this.column + 7 * b));
            ...
            result.add(new WWElementConductor(this.row - 7, this.column + 2 * b));
